        ...
        <div className="submenu">
          <ul>
            <li onClick={() => handleSubMenuClick("corpuri")}>
              <img className="icon" src="assets\corpuri.svg" alt=""></img>
              <h3>Corpuri</h3>
            </li>
            <li onClick={() => handleSubMenuClick("traiectorii")}>
              <img className="icon" src="assets\down-arrow.svg" alt=""></img>
              <h3>Traiectorii</h3>
            </li>
            <li onClick={() => handleSubMenuClick("viteze")}>
              <img className="icon" src="assets\sprint.svg" alt=""></img>
